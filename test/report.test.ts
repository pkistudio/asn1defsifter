...
describe('createCandidateReport', () => {
  const certificateHex = '';
  ...
  it('ranks RSA public key content inside SubjectPublicKeyInfo BIT STRING subtrees', async () => {
    ...
    expect(report.roots[0].subtrees?.find((subtree) => subtree.path === '$.1.0')?.candidates.map((candidate) => candidate.typeName)).not.toEqual(
      expect.arrayContaining(['DSA-Sig-Value', 'ECDSA-Sig-Value'])
    );
  });

  it('ranks decoded DSA/ECDSA signature values inside certificate signature BIT STRING subtrees', () => {
    const algorithmIdentifier = sequence([oid('1.2.840.10045.4.3.2')]);
    ...
    const subjectPublicKeyInfo = sequence([sequence([oid('1.2.840.10045.2.1'), oid('1.2.840.10045.3.1.7')]), bitString()]);
    const signatureValue = { ...bitString(), children: [sequence([integer(), integer()])] };
    const tbsCertificate = sequence([context(0, [integer()]), integer(), algorithmIdentifier, name, validity, name, subjectPublicKeyInfo]);
    const certificate = sequence([tbsCertificate, algorithmIdentifier, signatureValue]);
    const report = createPkiCandidateReportFromNodes(certificate, {
      includeSubtrees: true,
      maxSubtreeDepth: 4,
      maxSubtreeReports: 100,
      maxResults: 10
    });
    const signatureSequenceCandidates = report.roots[0].subtrees?.find((subtree) => subtree.path === '$.2.0')?.candidates.map((candidate) => candidate.typeName);

    expect(signatureSequenceCandidates).toEqual(expect.arrayContaining(['DSA-Sig-Value', 'ECDSA-Sig-Value']));
    expect(signatureSequenceCandidates).not.toContain('RSAPublicKey');
  });
  ...
  it('ranks certificate signature BIT STRING subtrees as SignatureValue candidates', async () => {
    const report = await createPkiCandidateReport(certificateHex, {
      parseOptions: { format: 'hex' },
      includeSubtrees: true,
      maxSubtreeDepth: 2,
      maxSubtreeReports: 10,
      maxResults: 8
    });

    expect(report.roots[0].subtrees?.find((subtree) => subtree.path === '$.2')?.summary.bestCandidate).toMatchObject({
